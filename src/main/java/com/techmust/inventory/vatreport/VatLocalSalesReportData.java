...
public class VatLocalSalesReportData extends TenantData 
{
	private static final long serialVersionUID = 1L;
	protected float m_nTax;
	protected float m_nTaxableAmount;
	protected float m_nTaxAmount;

	public VatLocalSalesReportData ()
	{
		m_nTax = 0;
		m_nTaxableAmount = 0;
		m_nTaxAmount = 0;
	...
	{
		String strVatLocalSalesReportXml = "";
		m_oLogger.info("generateXML");
		try 
		{
			Document oXmlDocument = createNewXMLDocument ();
			Element oRootElement = createRootElement(oXmlDocument, "VatLocalSalesReportData");
			...
			strVatLocalSalesReportXml = getXmlString (oXmlDocument);
		}
		catch (Exception oException) 
		{
			m_oLogger.error("generateXML - oException" + oException);
		}
		return strVatLocalSalesReportXml;
	}
