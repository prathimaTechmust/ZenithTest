package com.techmust.vendormanagement.initializer;
...
public class VendorManagementInitilizer
{
	public static Logger m_oLogger = Logger.getLogger (VendorManagementInitilizer.class);
	private static final String kDefaultXmlPath = "com/techmust/vendormanagement/resources/VendorManagement.defaults.xml";	
	...
	public static void initilize ()
	{
		...
		try
		{
			String strClientManagementXmlPath = AppProperties.getProperty ("VendorManagement.defaults");
			InputStream oDefaultXmlStream = VendorManagementInitilizer.class.getClassLoader ().getResourceAsStream (kDefaultXmlPath);
			Document oXMLClientDocument = getXmlDocument (strClientManagementXmlPath, oDefaultXmlStream);
			insertVendorManagementActions (oXMLClientDocument);
	...
	private static void insertVendorManagementActions (Document oXMLClientDocument) throws Exception
	{
		m_oLogger.info ("insertVendorManagementActions");
		m_oLogger.debug ("insertVendorManagementActions - oXMLClientDocument [IN] : " + oXMLClientDocument);
		...
		{
			m_oLogger.error ("insertVendorManagementActions - oException : " + oException);
			throw oException;
		}
	}
