...
function institutionInfo_created (oInstitutionInfoResponse)
{
	...
	{
		institutionInfo_displayInfo("institutioncreatedsuccessfully", "kSuccess");
	}
	else
		institutionInfo_displayInfo("institutioncreationfailed", "kError");
}
...
function institutionInfo_updated (oInstitutionInfoResponse)
{
	HideDialog ("ProcessDialog");
	if(oInstitutionInfoResponse.m_bSuccess)
		institutionInfo_displayInfo ("institutionupdatedsuccessfully");
	else
		institutionInfo_displayInfo ("institutionupdationfailed");
...
function institutionInfo_displayInfo (strMessage)
{
	...
	navigate("institutionList", "widgets/scholarshipmanagement/listInstitution.js")
}
