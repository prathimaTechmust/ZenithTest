...
{
	loadPage ("scholarshipmanagement/listCourseInfo.html", "workarea", "listCourseInfo_init ()");
}
...
{
	populateXMLData (strXMLData, "scholarshipmanagement/courseInfoDetails.xslt", 'listCourseInfo_div_listDetail');
}
...
function listCourseInfo_edit (nCourseId)
{
	...
	navigate ("actionInformation", "widgets/scholarshipmanagement/editCourseInfo.js");
}
...
function course_delete_Response (oResponse)
{
	...
	{
		informUser ("coursedeletedsuccessfully", "kSuccess");
		document.getElementById("listCourseInfo_div_listDetail").innerHTML = "";
		listCourseInfo_list (m_oCourseInfoListMemberData.m_strSortColumn, m_oCourseInfoListMemberData.m_strSortOrder, 1, 10);
	}
	else
...
{
	navigate ("newcourse", "widgets/scholarshipmanagement/newCourseInfo.js");
}
