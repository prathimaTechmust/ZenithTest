...
[
	...
	'widgets/usermanagement/userinfo/FacilitatorInformationData.js'
];
...
{
	loadPage ("usermanagement/userinfo/listFacilitatorInfo.html", "workarea", "listFacilitatorInfo_init ()");
}
...
{
	populateXMLData (strXMLData, "usermanagement/userinfo/facilitatorInfoDetails.xslt", 'listFacilitatorInfo_div_listDetail');
}
...
{
 	assert.isNumber(nFacilitatorId, "nUserId expected to be a Number.");
...
function listFacilitatorInfo_edit (nFacilitatorId)
{
	...
	navigate ("actionInformation", "widgets/usermanagement/userinfo/editFacilitatorInfo.js");
}
...
function facilitator_delete_Response (oResponse)
{
	...
	{
		informUser ("facilitatordeletedsuccessfully", "kSuccess");
		document.getElementById("listFacilitatorInfo_div_listDetail").innerHTML = "";
		listFacililtatorInfo_list (m_oFacilitatorInfoListMemberData.m_strSortColumn, m_oFacilitatorInfoListMemberData.m_strSortOrder, 1, 10);
	}
	else
...
{
	navigate ("newfacilitator", "widgets/usermanagement/userinfo/newFacilitatorInfo.js");
}
