								...
								<tr>
									<td class="zenith" align="left">
										<table class="zenith">
											<tr>
											   <td>
												  <button type="button" width="20" align="center"  class="zenith addButton" style="width:140px;" id="tobeapprove" title="approvel" onclick="approve_counselingStudent()" >Send To Approve</button>
												</td>
												<td>
												  <button type="button" width="20" align="center"  class="zenith addButton" style="width:100px;" id="reject" title="reject" onclick="recjectInfo_Student()" >Reject</button>
												</td>
												<td>
