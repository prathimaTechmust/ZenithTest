		            		...
		            		<table class="nil-spacing">
		            			<tr>
		            				<td class="nil-spacing border-all border-no-left" style="width:50%;vertical-align:top;height:32px">
		            					<table class="nil-spacing">
		            						<tr>
		            							<td class="fieldHeader-print nil-spacing">Challan No</td>
		            						</tr>
		            						<tr>
		            							<td class="fieldData-print"><xsl:value-of select="ChallanData/m_strChallanNumber" /></td>
		            						</tr>
		            					</table>
		            				</td>
		            				<td class="nil-spacing border-all border-no-left border-no-right" style="width:50%;vertical-align:top;"> 
		            					<table class="nil-spacing">
		            						...
		            						<tr>
		            							<td class="fieldData-print">
		            								<xsl:value-of select="ChallanData/m_strDate"/>
		            							</td>
		            						</tr>
		            					</table>
		            				</td>
						    			...
						    			<tr>
						          		...
						          		<tr>
						                    <td class="fieldData-print" style="vertical-align:top">
												...
												<xsl:value-of select="ChallanData/m_oSalesData/SalesData/ClientData/m_strCity" /> - <xsl:value-of select="ChallanData/m_oSalesData/SalesData/ClientData/m_strPinCode" />
						                    </td>
						          		</tr>
		        					  </table>
				                    </td>
				                        ...
				                        <tr>
				                          <td class="nil-spacing border-right" style="width:50%;vertical-align:top;height:32px">
				                          	<table class="nil-spacing">
			            						...
			            						<tr>
			            							<td class="fieldData-print">
			            								<xsl:value-of select="ChallanData/m_oSalesData/SalesData/ClientData/m_strTinNumber" />
			            							</td>
			            						</tr>
		            						</table>
				                          </td>
				                          <td class="nil-spacing" style="width:50%;vertical-align:top;">
				                          	<table class="nil-spacing">
			            						...
			            						<tr>
			            							<td class="fieldData-print">
			            								<xsl:value-of select="ChallanData/m_oSalesData/SalesData/ClientData/m_strCSTNumber" />
			            							</td>
			            						</tr>
		            						</table>
				                          </td>
		            			...
		            			<tr>
		            				<td class="nil-spacing border-top-right" style="width:50%;vertical-align:top;height:32px">
		            					<table class="nil-spacing">
		            						...
		            						<tr>
		            							<td class="fieldData-print">
		            								<xsl:value-of select="ChallanData/m_oSalesData/SalesData/m_strPurchaseOrderNumber"/>
		            							</td>
		            						</tr>
		            					</table>
		            				</td>
		            				<td class="nil-spacing border-top" style="width:50%;vertical-align:top;"> 
		            					<table class="nil-spacing">
		            						...
		            						<tr>
		            							<td class="fieldData-print">
		            								<xsl:value-of select="ChallanData/m_oSalesData/SalesData/m_strPurchaseOrderDate"/>
		            							</td>
		            						</tr>
		            					</table>
		            				</td>
		        ...
		        <td class="nil-spacing" style="height:640px;vertical-align:top">
		          <table class="nil-spacing border-collapse">
		            ...
		            <tr>
						...
						<td class="fieldData-print border-bottom" style="width:13%;text-align:right">
							<xsl:value-of select="format-number(round(ChallanData/m_nChallanAmount) - (ChallanData/m_nChallanAmount) ,'##,##,##,##0.00')"/>
						</td>
		            </tr>
		          </table>
		        </td>
		        		...
		        		<table class="nil-spacing">
		        			<tr>
				              ...
				              <td class="fieldData-print border-all border-no-left" style="width:10%;text-align:right;">
				              	<xsl:value-of select="format-number(sum(ChallanData/m_oSalesData/SalesData/m_oSalesLineItems/totalQuantity),'##,##,##,###.00')"/>
				              </td>
				              ...
				              <td class="fieldData-print border-all border-no-left border-no-right" style="width:13%;text-align:right">
				              	<span class="rupeeSign" style="font-weight: normal;">R </span><xsl:value-of select="format-number(round(ChallanData/m_nChallanAmount),'##,##,##,##0.00')"/>
		              		  </td>
				            </tr>
		        		</table>
		        	</td>
		            	 ...
		            	 <tr>
		                    <td class="nil-spacing" style="width:50%;vertical-align:top;height:85px">
		                      <table class="nil-spacing">
		                        ...
		                        <tr>
		                          <td class="fieldData-print"><xsl:value-of select="ChallanData/m_nChallanAmountInWords" /></td>
		                        </tr>
		                        <tr>
		                          <td class="fieldHeader-print">Tax Amount(in words)</td>
		                        </tr>
		                        <tr>
		                          <td class="fieldData-print"><xsl:value-of select="ChallanData/m_oSalesData/SalesData/m_oTaxes/totalTaxAmountInWords" /></td>
		                        </tr>
		                      </table>
		                    </td>
		                    <td class="nil-spacing" style="width:50%;vertical-align:top">
