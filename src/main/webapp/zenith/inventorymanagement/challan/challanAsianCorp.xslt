												...
												<td class="print_fieldData print_tdBorderBottom" style="text-align:left" id="m_strDateTime">
													<table  class="trademust">
														<tr>
															...
															<td style="width:55%;font-weight:bold;vertical-align: top;"><xsl:value-of select="ChallanData/m_strDate"/><br/><xsl:value-of select="ChallanData/m_strTime"/></td>
														</tr>
													</table>
												</td>
											</tr>
												...
												<td class="print_fieldData  print_tdBorderBottom" style="text-align:left">
													<table  class="trademust">
														<tr>
															...
															<td style="width:5%;">:<br/>:</td>
															<td style="width:55%;font-weight:bold;vertical-align: top;"><xsl:value-of select="ChallanData/m_oSalesData/SalesData/ClientData/m_strTinNumber" /><br/><xsl:value-of select="ChallanData/m_oSalesData/SalesData/ClientData/m_strCSTNumber" /></td>
														</tr>
													</table>
												</td>
											</tr>
												...
												<td class="print_fieldData print_tdBorderBottom" style="text-align:left">
													<table  class="trademust">
														<tr>
															...
															<td style="width:5%;">:</td>
															<td style="width:55%;font-weight:bold"><xsl:value-of select="ChallanData/m_oSalesData/SalesData/m_strPurchaseOrderNumber"/></td>
														</tr>
													</table>
												</td>
											</tr>
												...
												<td class="print_fieldData print_tdBorderBottom" style="text-align:left">
													<table  class="trademust">
														<tr>
															...
															<td style="width:5%;">:</td>
															<td style="width:55%;font-weight:bold"><xsl:value-of select="ChallanData/m_strChallanNumber"/></td>
														</tr>
													</table>
												</td>
											</tr>
												...
												<td class="print_fieldData" style="text-align:left">
													<table  class="trademust">
														<tr>
															...
															<td style="width:5%;">:</td>
															<td style="width:55%;font-weight:bold"><xsl:value-of select="ChallanData/m_strDate"/></td>
														</tr>
													</table>
												</td>
											</tr>
										...
										<div style="min-height:550px">
											<table class="print_tableBorder trademust">
												<tr>
													...
													<td class="print_fieldTableHeading print_tdBorder" style="width:13%;text-align:center">
														Amount
													</td>
												</tr>
