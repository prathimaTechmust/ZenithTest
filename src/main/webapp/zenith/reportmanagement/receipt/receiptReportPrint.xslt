...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<xsl:variable name="grandTotal"
			select="sum(root/ReceiptReportDataList/ReceiptReportData/m_nAmount)" />
		<html>
			<body>
				<table class="trademust">
					<tr>
						<td class="print_formHeading" colspan="2">
							Receipt Report [From:<xsl:value-of select="root/m_strFromDate"/> - To:<xsl:value-of select="root/m_strToDate"/>]
          				</td>
					</tr>
					<tr>
						<td class="trademust" colspan="2">
							<table class="trademust">
								<tr>
									...
									<td class="print_fieldTableHeading" style="width:50%;">
										Client Name : <xsl:value-of select="root/m_strClientNameFilterBox"/>
									</td>
								</tr>
							</table>
          				</td>
										...
										<div style="height:1025px">
											<table class="print_tableBorder trademust">
												<tr>
													...
													<td class="print_fieldTableHeading print_tdBorder" style="width:60%">
														Client Name
													</td>
												...
												<xsl:for-each select="root/ReceiptReportDataList/ReceiptReportData">
													<tr>
