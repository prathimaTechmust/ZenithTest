												...
												<td class="print_fieldData  print_tdBorderBottom" style="text-align:left">
													<table  class="traderp">
														<tr>
															...
															<td style="width:5%;">:<br/>:</td>
															<td style="width:55%;"><xsl:value-of select="InvoiceData/m_oSalesSet/SalesData/ClientData/m_strTinNumber" /><br/><xsl:value-of select="SalesData/ClientData/m_strCSTNumber" /></td>
														</tr>
													</table>
												</td>
											</tr>
										...
										<div style="height:730px">
											<table class="print_tableBorder traderp">
												...
												<xsl:for-each select="InvoiceData/m_oSalesSet/SalesData">
													...
													<xsl:for-each select="m_oSalesLineItems/SalesLineItemData">
														<tr>
															...
															<td class="print_fieldTableData print_tdBorder" style="text-align:right">
																<span class="rupeeSign" style="font-weight: normal;">R </span><xsl:value-of select="format-number(m_nPrice, '##,##,##,##0.00')" />
															</td>
															<td class="print_fieldTableData print_tdBorder" style="text-align:right">
